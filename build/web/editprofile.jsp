                        ...
                        <div class="col-lg-12">
                            <div class="well well-lg">
                                <form method="post" action="ProfileUserUpdateServlet">
                                    ...
                                    <p><input class="form-control" name="fullname" type="text" value="${sessionScope.memberprofile.getFullname()}" placeholder="Full Name" readonly></p>
                                    <p><label for="Username">Username: </label>
                                    <p><input class="form-control" name="username" type="text" value="${sessionScope.memberprofile.getUsername()}" placeholder="Username" readonly></p>
                                    <p><label for="Username">Phone  </label>
                                    <p><input class="form-control" name="phoneNo" type="text" value="${sessionScope.memberprofile.getPhoneNo()}" placeholder="Phone Number"></p>
                                    <p><label for="Username">Email: </label>
                                    <p><input class="form-control" name="email" type="text" value="${sessionScope.memberprofile.getEmail()}" placeholder="Email" readonly></p>
                                    <p><label for="Username">Password </label>
                                    <p><input class="form-control" type="password" name="password" id="name" value="" placeholder="Password" required></p>
